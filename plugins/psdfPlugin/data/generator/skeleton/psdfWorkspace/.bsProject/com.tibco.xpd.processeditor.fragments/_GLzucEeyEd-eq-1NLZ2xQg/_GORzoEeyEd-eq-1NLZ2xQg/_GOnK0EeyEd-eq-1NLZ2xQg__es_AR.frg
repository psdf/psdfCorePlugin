...
<xpdl2:Package xmlns:simulation="http://www.tibco.com/xpd/Simulation1.0.1" xmlns:xpdExt="http://www.tibco.com/XPD/xpdExtension1.0.0" xmlns:xpdl2="http://www.wfmc.org/2008/XPDL2.1" Id="_QGCmwJwiEd2-V4H1CvFFfg" Name="Subproc1foruseinmappingsnoparameters">
  <xpdl2:PackageHeader>
  ...
  <xpdl2:Artifacts>
    <xpdl2:Artifact Id="_td9o5uODEduPAb4MANvU-g" ArtifactType="Annotation" TextAnnotation="4 Data Fields defined - Text, Integer, Float, DateTimeNo Parameters definedThis cannot currently be used in Studio unless there are genuinely no input/output parameters">
      <xpdl2:NodeGraphicsInfos>
