...
<xpdl2:Package xmlns:xpdl2="http://www.wfmc.org/2008/XPDL2.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:iProcessExt="http://www.tibco.com/XPD/iProcessExt1.0.0" xmlns:simulation="http://www.tibco.com/xpd/Simulation1.0.1" xmlns:xpdExt="http://www.tibco.com/XPD/xpdExtension1.0.0" xsi:schemaLocation="http://www.wfmc.org/2008/XPDL2.1 http://www.wfmc.org/standards/bpmnxpdl_31.xsd" Id="_zAeFII2DEd2zaKmu6x991g" Name="Waitwith3pathsincoming">
  <xpdl2:PackageHeader>
    <xpdl2:XPDLVersion>2.1</xpdl2:XPDLVersion>
    <xpdl2:Description/>
  </xpdl2:PackageHeader>
  <xpdl2:Pools>
    <xpdl2:Pool Id="_Fragment_Dummy_Pool_" Name="Pool" Process="_MaMQsOOEEduPAb4MANvU-g">
      <xpdl2:Lanes>
  ...
  <xpdl2:WorkflowProcesses>
    <xpdl2:WorkflowProcess Id="_MaMQsOOEEduPAb4MANvU-g" xpdExt:DisplayName="Wait with 3 paths incoming" Name="Waitwith3pathsincoming">
      ...
      <xpdl2:Activities>
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_MaMQmOOEEduPAb4MANvU-g" Name="allpaths" xpdExt:DisplayName="all paths">
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_MaMQmeOEEduPAb4MANvU-g" Name="UserStep1" FinishMode="Manual" StartMode="Manual" xpdExt:DisplayName="User Step 1">
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_MaMQnOOEEduPAb4MANvU-g" Name="EAIStep" FinishMode="Automatic" StartMode="Automatic" xpdExt:DisplayName="EAI Step">
          <xpdl2:Implementation>
            <xpdl2:Task>
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_MaMQn-OEEduPAb4MANvU-g" Name="WAITstep" xpdExt:DisplayName="WAIT step">
          <xpdl2:Route GatewayType="Parallel"/>
          <xpdl2:TransitionRestrictions>
            <xpdl2:TransitionRestriction>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_MaMQoOOEEduPAb4MANvU-g" Name="USERStep2" FinishMode="Manual" StartMode="Manual" xpdExt:DisplayName="USER Step 2">
          <xpdl2:Implementation>
            <xpdl2:Task>
              <xpdl2:TaskUser Implementation="Unspecified">
                <xpdl2:Performers>
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_MaMQpOOEEduPAb4MANvU-g" Name="Eventstep" xpdExt:DisplayName="Event step">
          <xpdl2:Event>
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_MaMQpeOEEduPAb4MANvU-g" Name="Stop" xpdExt:DisplayName="Stop">
          <xpdl2:Event>
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_MaMQpuOEEduPAb4MANvU-g" Name="Start" xpdExt:DisplayName="Start">
          <xpdl2:Event>
