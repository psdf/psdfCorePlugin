...
<xpdl2:Package xmlns:xpdl2="http://www.wfmc.org/2008/XPDL2.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:iProcessExt="http://www.tibco.com/XPD/iProcessExt1.0.0" xmlns:simulation="http://www.tibco.com/xpd/Simulation1.0.1" xmlns:xpdExt="http://www.tibco.com/XPD/xpdExtension1.0.0" xsi:schemaLocation="http://www.wfmc.org/2008/XPDL2.1 http://www.wfmc.org/standards/bpmnxpdl_31.xsd" Id="_zFr8UI2DEd2zaKmu6x991g" Name="EventstepInlineandStandAlone">
  <xpdl2:PackageHeader>
    <xpdl2:XPDLVersion>2.1</xpdl2:XPDLVersion>
    <xpdl2:Description/>
  </xpdl2:PackageHeader>
  <xpdl2:Pools>
    <xpdl2:Pool Id="_Fragment_Dummy_Pool_" Name="Pool" Process="_LzVhYOODEduPAb4MANvU-g">
      <xpdl2:Lanes>
  ...
  <xpdl2:Artifacts>
    ...
    <xpdl2:Artifact Id="_p68GwI4BEd2zaKmu6x991g" ArtifactType="Annotation" TextAnnotation="Note:The Stand-Alone Event is actually a BPMN Task of type &quot;Receive&quot;.&#13;&#10;This will map to an iProcess Event step.">
      <xpdl2:NodeGraphicsInfos>
  ...
  <xpdl2:WorkflowProcesses>
    <xpdl2:WorkflowProcess Id="_LzVhYOODEduPAb4MANvU-g" xpdExt:DisplayName="Event step - Inline and StandAlone" Name="EventstepInlineandStandAlone">
      ...
      <xpdl2:Activities>
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_LzVhWOODEduPAb4MANvU-g" Name="StandAloneEvent" xpdExt:DisplayName="Stand-Alone Event">
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_LzVhW-ODEduPAb4MANvU-g" Name="End" xpdExt:DisplayName="End">
          <xpdl2:Event>
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_LzVhXOODEduPAb4MANvU-g" Name="InlineEvent" xpdExt:DisplayName="Inline Event">
          <xpdl2:Event>
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_LzVhXeODEduPAb4MANvU-g" Name="Start" xpdExt:DisplayName="Start">
          <xpdl2:Event>
