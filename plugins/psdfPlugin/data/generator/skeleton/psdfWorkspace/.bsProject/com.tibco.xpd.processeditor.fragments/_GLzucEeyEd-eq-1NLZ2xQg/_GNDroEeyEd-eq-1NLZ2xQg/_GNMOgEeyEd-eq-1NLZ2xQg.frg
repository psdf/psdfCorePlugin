...
<xpdl2:Package xmlns:xpdl2="http://www.wfmc.org/2008/XPDL2.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:iProcessExt="http://www.tibco.com/XPD/iProcessExt1.0.0" xmlns:simulation="http://www.tibco.com/xpd/Simulation1.0.1" xmlns:xpdExt="http://www.tibco.com/XPD/xpdExtension1.0.0" xsi:schemaLocation="http://www.wfmc.org/2008/XPDL2.1 http://www.wfmc.org/standards/bpmnxpdl_31.xsd" Id="_zHeFAI2DEd2zaKmu6x991g" Name="EventreleasewithdrawsaUserstep">
  <xpdl2:PackageHeader>
    <xpdl2:XPDLVersion>2.1</xpdl2:XPDLVersion>
    <xpdl2:Description/>
  </xpdl2:PackageHeader>
  <xpdl2:Pools>
    <xpdl2:Pool Id="_Fragment_Dummy_Pool_" Name="Pool" Process="_P1UwNuODEduPAb4MANvU-g">
      <xpdl2:Lanes>
  ...
  <xpdl2:WorkflowProcesses>
    <xpdl2:WorkflowProcess Id="_P1UwNuODEduPAb4MANvU-g" xpdExt:DisplayName="Event release withdraws a User step" Name="EventreleasewithdrawsaUserstep">
      ...
      <xpdl2:Activities>
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_P1UwI-ODEduPAb4MANvU-g" Name="bothpaths" xpdExt:DisplayName="both paths">
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_P1UwJOODEduPAb4MANvU-g" Name="UserTask2" IsATransaction="false" xpdExt:DisplayName="User Task 2">
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_P1UwKOODEduPAb4MANvU-g" Name="End3" xpdExt:DisplayName="End3">
          <xpdl2:Event>
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_P1UwKeODEduPAb4MANvU-g" Name="Start" xpdExt:DisplayName="Start">
          <xpdl2:Event>
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_P1UwKuODEduPAb4MANvU-g" Name="End1" xpdExt:DisplayName="End1">
          <xpdl2:Event>
            <xpdl2:EndEvent Result="None"/>
          </xpdl2:Event>
          <xpdl2:ExtendedAttributes>
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_P1UwK-ODEduPAb4MANvU-g" Name="CancelUserTask2" xpdExt:DisplayName="Cancel User Task 2">
          <xpdl2:Event>
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_P1UwLOODEduPAb4MANvU-g" Name="End2" xpdExt:DisplayName="End2">
          <xpdl2:Event>
            <xpdl2:EndEvent Result="None"/>
          </xpdl2:Event>
          <xpdl2:ExtendedAttributes>
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_P1UwLeODEduPAb4MANvU-g" Name="Task2cancelled" xpdExt:DisplayName="Task 2 cancelled">
          <xpdl2:Event>
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_P1UwLuODEduPAb4MANvU-g" Name="Event1" xpdExt:DisplayName="Event1">
          <xpdl2:Event>
...
<simulation:SplitSimulationData>
      ...
      <xpdl2:Transitions>
        ...
        <xpdl2:Transition Id="_Qd_LQY4BEd2zaKmu6x991g" Name="" From="_P1UwI-ODEduPAb4MANvU-g" To="_P1UwLuODEduPAb4MANvU-g">
          <xpdl2:ConnectorGraphicsInfos>
            <xpdl2:ConnectorGraphicsInfo BorderColor="0,0,128" ToolId="XPD.ConnectionInfo">
        ...
        <xpdl2:Transition Id="_RsXp8I4BEd2zaKmu6x991g" Name="" From="_P1UwLuODEduPAb4MANvU-g" To="_P1UwK-ODEduPAb4MANvU-g">
          <xpdl2:ConnectorGraphicsInfos>
            <xpdl2:ConnectorGraphicsInfo BorderColor="0,0,128" ToolId="XPD.ConnectionInfo"/>
          </xpdl2:ConnectorGraphicsInfos>
        </xpdl2:Transition>
        <xpdl2:Transition Id="_SHVusI4BEd2zaKmu6x991g" Name="" From="_P1UwK-ODEduPAb4MANvU-g" To="_P1UwKuODEduPAb4MANvU-g">
          <xpdl2:ConnectorGraphicsInfos>
            <xpdl2:ConnectorGraphicsInfo BorderColor="0,0,128" ToolId="XPD.ConnectionInfo"/>
          </xpdl2:ConnectorGraphicsInfos>
        </xpdl2:Transition>
