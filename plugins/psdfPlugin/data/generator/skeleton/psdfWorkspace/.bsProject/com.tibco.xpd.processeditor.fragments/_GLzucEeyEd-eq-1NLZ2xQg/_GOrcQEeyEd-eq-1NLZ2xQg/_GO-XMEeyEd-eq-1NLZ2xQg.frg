...
<xpdl2:Package xmlns:xpdl2="http://www.wfmc.org/2008/XPDL2.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:iProcessExt="http://www.tibco.com/XPD/iProcessExt1.0.0" xmlns:simulation="http://www.tibco.com/xpd/Simulation1.0.1" xmlns:xpdExt="http://www.tibco.com/XPD/xpdExtension1.0.0" xsi:schemaLocation="http://www.wfmc.org/2008/XPDL2.1 http://www.wfmc.org/standards/bpmnxpdl_31.xsd" Id="_zI950I2DEd2zaKmu6x991g" Name="UserStepwithEscalationandWithdrawal">
  <xpdl2:PackageHeader>
    <xpdl2:XPDLVersion>2.1</xpdl2:XPDLVersion>
    <xpdl2:Description/>
  </xpdl2:PackageHeader>
  <xpdl2:Pools>
    <xpdl2:Pool Id="_Fragment_Dummy_Pool_" Name="Pool" Process="_N9asxP71EduRnKf2Rd_RwQ">
      <xpdl2:Lanes>
  ...
  <xpdl2:Associations>
    <xpdl2:Association Id="_pay5AI3_Ed2zaKmu6x991g" Name="" AssociationDirection="None" Source="_N9asuf71EduRnKf2Rd_RwQ" Target="_k7fcII3_Ed2zaKmu6x991g">
  ...
  <xpdl2:Artifacts>
    ...
    <xpdl2:Artifact Id="_dJWVgI3_Ed2zaKmu6x991g" ArtifactType="Annotation" TextAnnotation="The timeout causes the Manual Step to be withdrawn - an escalation is sent out instead and the process does not proceed towards the &quot;end&quot; event.&#13;&#10;If the deadline does not expire, the process continues towards the &quot;end&quot; event when the user step is released">
      <xpdl2:NodeGraphicsInfos>
  ...
  <xpdl2:WorkflowProcesses>
    <xpdl2:WorkflowProcess Id="_N9asxP71EduRnKf2Rd_RwQ" xpdExt:DisplayName="User Step with Escalation and Withdrawal" Name="UserStepwithEscalationandWithdrawal">
      ...
      <xpdl2:Activities>
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_N9assv71EduRnKf2Rd_RwQ" Name="UserStep" IsATransaction="false" xpdExt:DisplayName="User Step">
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_N9astf71EduRnKf2Rd_RwQ" Name="Escalation" IsATransaction="false" xpdExt:DisplayName="Escalation">
          <xpdl2:Implementation>
            <xpdl2:Task>
              <xpdl2:TaskUser Implementation="Unspecified">
                <xpdl2:Performers>
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_N9asuP71EduRnKf2Rd_RwQ" Name="Start" xpdExt:DisplayName="Start">
          <xpdl2:Event>
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_N9asuf71EduRnKf2Rd_RwQ" Name="deadline" xpdExt:DisplayName="deadline">
          <xpdl2:Description>&#13;
</xpdl2:Description>
          <xpdl2:Event>
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_N9asuv71EduRnKf2Rd_RwQ" Name="End" xpdExt:DisplayName="End">
          <xpdl2:Event>
...
<simulation:SplitSimulationData>
        ...
        <xpdl2:Activity xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:database="http://www.tibco.com/XPD/database1.0.0" Id="_N9asu_71EduRnKf2Rd_RwQ" Name="End2" xpdExt:DisplayName="End2">
          <xpdl2:Event>
            <xpdl2:EndEvent Result="None"/>
          </xpdl2:Event>
          <xpdl2:ExtendedAttributes>
