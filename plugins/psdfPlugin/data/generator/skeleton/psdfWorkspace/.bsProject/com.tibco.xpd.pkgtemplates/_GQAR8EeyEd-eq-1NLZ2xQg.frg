...
<xpdl2:Package xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:database="http://www.tibco.com/XPD/database1.0.0" xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:iProcessExt="http://www.tibco.com/XPD/iProcessExt1.0.0" xmlns:simulation="http://www.tibco.com/xpd/Simulation1.0.1" xmlns:xpdExt="http://www.tibco.com/XPD/xpdExtension1.0.0" xmlns:xpdl2="http://www.wfmc.org/2008/XPDL2.1" xsi:schemaLocation="http://www.wfmc.org/2008/XPDL2.1 http://www.wfmc.org/standards/bpmnxpdl_31.xsd" Id="_l2BEAK8XEd2BUfeaOl0GHw" xpdExt:DisplayName="CIM Package Template" Name="CIMPackageTemplate">
          ...
          <xpdl2:Implementation>
            <xpdl2:Task>
              <xpdl2:TaskService xpdExt:ImplementationType="WebService" Implementation="WebService">
                <xpdl2:MessageIn Id="_X7i5smRwEd6TNdiHFP5kVQ"/>
                <xpdl2:MessageOut Id="_X7i5s2RwEd6TNdiHFP5kVQ"/>
      ...
      <xpdl2:Activities>
        ...
        <xpdl2:Activity Id="_0ELL168XEd2BUfeaOl0GHw" Name="SetstatusToTimeOut" xpdExt:DisplayName="SetstatusToTimeOut">
          <xpdl2:Implementation>
            <xpdl2:Task>
              <xpdl2:TaskService xpdExt:ImplementationType="WebService" Implementation="WebService">
                <xpdl2:MessageIn Id="_9XSF8mRxEd6TNdiHFP5kVQ">
                  <xpdl2:DataMappings>
                    <xpdl2:DataMapping Direction="IN" Formal="wso:null/part:parameters/group:sequence[1]/eventState[0]">
                      <xpdExt:ScriptInformation Id="_9xWy0GRxEd6TNdiHFP5kVQ" Name="eventState_Value">
                        <xpdExt:Expression ScriptGrammar="XPath"></xpdExt:Expression>
                    ...
                    <xpdl2:DataMapping Direction="IN" Formal="wso:null/part:parameters/group:sequence[1]/eventStatus[1]">
                      <xpdExt:ScriptInformation Id="_-j304GRxEd6TNdiHFP5kVQ" Name="eventStatus_Value">
                        <xpdExt:Expression ScriptGrammar="XPath"></xpdExt:Expression>
                      </xpdExt:ScriptInformation>
                ...
                <xpdl2:MessageOut Id="_9XSF82RxEd6TNdiHFP5kVQ"/>
                <xpdl2:WebServiceOperation xpdExt:SecurityProfile="" xpdExt:Transport="http://schemas.xmlsoap.org/soap/http" xpdExt:Alias="">
                  <xpdl2:Service xpdExt:IsRemote="true">
                    <xpdl2:EndPoint EndPointType="WSDL">
                      <xpdl2:ExternalReference location="CIMServices.wsdl"/>
        ...
        <xpdl2:Activity Id="_0ELL2q8XEd2BUfeaOl0GHw" Name="SetStatusToError" xpdExt:DisplayName="SetStatusToError">
          <xpdl2:Implementation>
            <xpdl2:Task>
              <xpdl2:TaskService xpdExt:ImplementationType="WebService" Implementation="WebService">
                <xpdl2:MessageIn Id="_b8WnQmRxEd6TNdiHFP5kVQ">
                  <xpdl2:DataMappings>
                    <xpdl2:DataMapping Direction="IN" Formal="wso:null/part:parameters/group:sequence[1]/eventState[0]">
                      <xpdExt:ScriptInformation Id="_cVijUGRxEd6TNdiHFP5kVQ" Name="eventState_Value">
                        <xpdExt:Expression ScriptGrammar="XPath"></xpdExt:Expression>
                      </xpdExt:ScriptInformation>
                      <xpdl2:Actual ScriptGrammar="XPath">'DONE'</xpdl2:Actual>
                    </xpdl2:DataMapping>
                    <xpdl2:DataMapping Direction="IN" Formal="wso:null/part:parameters/group:sequence[1]/eventStatus[1]">
                      <xpdExt:ScriptInformation Id="_dZodkGRxEd6TNdiHFP5kVQ" Name="eventStatus_Value">
                        <xpdExt:Expression ScriptGrammar="XPath"></xpdExt:Expression>
                      </xpdExt:ScriptInformation>
                ...
                <xpdl2:MessageOut Id="_b8WnQ2RxEd6TNdiHFP5kVQ"/>
                <xpdl2:WebServiceOperation xpdExt:SecurityProfile="" xpdExt:Transport="http://schemas.xmlsoap.org/soap/http" xpdExt:Alias="">
                  <xpdl2:Service xpdExt:IsRemote="true">
                    <xpdl2:EndPoint EndPointType="WSDL">
                      <xpdl2:ExternalReference location="CIMServices.wsdl"/>
        ...
        <xpdl2:Activity Id="_0ELL3a8XEd2BUfeaOl0GHw" Name="SetStatusToCancel" xpdExt:DisplayName="SetStatusToCancel">
          <xpdl2:Implementation>
            <xpdl2:Task>
              <xpdl2:TaskService xpdExt:ImplementationType="WebService" Implementation="WebService">
                <xpdl2:MessageIn Id="_9iiwMmRwEd6TNdiHFP5kVQ">
                  <xpdl2:DataMappings>
                    <xpdl2:DataMapping Direction="IN" Formal="wso:null/part:parameters/group:sequence[1]/eventState[0]">
                      <xpdExt:ScriptInformation Id="_D8oewGRxEd6TNdiHFP5kVQ" Name="eventState_Value">
                        <xpdExt:Expression ScriptGrammar="XPath"></xpdExt:Expression>
                      </xpdExt:ScriptInformation>
                      <xpdl2:Actual ScriptGrammar="XPath">'DONE'</xpdl2:Actual>
                    </xpdl2:DataMapping>
                    <xpdl2:DataMapping Direction="IN" Formal="wso:null/part:parameters/group:sequence[1]/eventStatus[1]">
                      <xpdExt:ScriptInformation Id="_FDG-oGRxEd6TNdiHFP5kVQ" Name="eventStatus_Value">
                        <xpdExt:Expression ScriptGrammar="XPath"></xpdExt:Expression>
                      </xpdExt:ScriptInformation>
                ...
                <xpdl2:MessageOut Id="_9iiwM2RwEd6TNdiHFP5kVQ"/>
                <xpdl2:WebServiceOperation xpdExt:SecurityProfile="" xpdExt:Transport="http://schemas.xmlsoap.org/soap/http" xpdExt:Alias="">
                  <xpdl2:Service xpdExt:IsRemote="true">
                    <xpdl2:EndPoint EndPointType="WSDL">
                      <xpdl2:ExternalReference location="CIMServices.wsdl"/>
