...
<xpdl2:Package xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:database="http://www.tibco.com/XPD/database1.0.0" xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:iProcessExt="http://www.tibco.com/XPD/iProcessExt1.0.0" xmlns:orchestrator="http://www.tibco.com/XPD/orchestrator1.0.0" xmlns:order="http://www.tibco.com/XPD/order1.0.0" xmlns:simulation="http://www.tibco.com/xpd/Simulation1.0.1" xmlns:xpdExt="http://www.tibco.com/XPD/xpdExtension1.0.0" xmlns:xpdl2="http://www.wfmc.org/2008/XPDL2.1" xsi:schemaLocation="http://www.wfmc.org/2008/XPDL2.1 http://www.wfmc.org/standards/bpmnxpdl_31.xsd" Id="_5-oAAGWNEd6oJedOmyoJMA" xpdExt:DisplayName="ProcessPackage" Name="ProcessPackage">
  ...
  <xpdl2:ExternalPackages>
    <xpdl2:ExternalPackage Id="_5-oABWWNEd6oJedOmyoJMA" href="Sample Processes">
  ...
  <xpdl2:WorkflowProcesses>
    <xpdl2:WorkflowProcess Id="_5-oADGWNEd6oJedOmyoJMA" iProcessExt:NextParamSequenceNum="3" xpdExt:DisplayName="IPCFULFI" Name="IPCFULFI">
      <xpdl2:ProcessHeader>
        <xpdl2:Description></xpdl2:Description>
      </xpdl2:ProcessHeader>
      <xpdl2:DataFields>
      ...
      <xpdl2:Activities>
        <xpdl2:Activity Id="_5-oADWWNEd6oJedOmyoJMA" Name="StartEvent" xpdExt:DisplayName="Start Event" xpdExt:Visibility="Private">
          <xpdl2:Event>
        ...
        <xpdl2:Activity Id="_5-oAD2WNEd6oJedOmyoJMA" Name="Input" xpdExt:Visibility="Private" xpdExt:DisplayName="Input">
          <xpdl2:Implementation>
            <xpdl2:Task>
              <xpdl2:TaskUser Implementation="Unspecified">
                ...
                <xpdl2:MessageIn Id="_5-oAEGWNEd6oJedOmyoJMA"/>
                <xpdl2:MessageOut Id="_5-oAEWWNEd6oJedOmyoJMA"/>
              </xpdl2:TaskUser>
            </xpdl2:Task>
          </xpdl2:Implementation>
          <xpdl2:Performers>
          ...
          <iProcessExt:TaskProperties NoDeleteOnWithdraw="false" IgnoreCaseSuspend="false">
            ...
            <iProcessExt:UserTask Forwardable="false" CopyEnabled="false"/>
          ...
          <xpdl2:Implementation>
            <xpdl2:Task>
              <xpdl2:TaskService xpdExt:ImplementationType="Order" Implementation="Other">
                <xpdl2:MessageIn Id="_5-oAE2WNEd6oJedOmyoJMA"/>
                <xpdl2:MessageOut Id="_5-oAFGWNEd6oJedOmyoJMA"/>
                <order:Order>
                  <order:OrderIdentification order:OrderPrimaryKeyField="_5-xxCGWNEd6oJedOmyoJMA" order:OrderAmendmentIndexField="_5-xxB2WNEd6oJedOmyoJMA"/>
                  <order:OrderStateChange order:Transition="Feasibility"/>
                  <order:OrderLineStateChange>
                    <order:XPathSelection>/:order/:lines/:line/:status</order:XPathSelection>
                  </order:OrderLineStateChange>
                  <order:ExceptionHandling/>
                </order:Order>
              </xpdl2:TaskService>
            </xpdl2:Task>
          </xpdl2:Implementation>
          ...
          <xpdl2:Implementation>
            <xpdl2:Task>
              <xpdl2:TaskReceive xpdExt:ImplementationType="Unspecified" Implementation="Unspecified">
                <xpdl2:Message Id="_5-oAFmWNEd6oJedOmyoJMA"/>
              </xpdl2:TaskReceive>
            </xpdl2:Task>
          </xpdl2:Implementation>
          <xpdl2:NodeGraphicsInfos>
        ...
        <xpdl2:Activity Id="_5-oAF2WNEd6oJedOmyoJMA" Name="update" xpdExt:Visibility="Private" xpdExt:DisplayName="update">
          <xpdl2:Implementation>
            <xpdl2:Task>
              <xpdl2:TaskReceive xpdExt:ImplementationType="Unspecified" Implementation="Unspecified">
                <xpdl2:Message Id="_5-oAGGWNEd6oJedOmyoJMA"/>
              </xpdl2:TaskReceive>
            </xpdl2:Task>
          </xpdl2:Implementation>
          <xpdl2:NodeGraphicsInfos>
          ...
          <xpdl2:Implementation>
            <xpdl2:Task>
              <xpdl2:TaskUser Implementation="Unspecified">
                ...
                <xpdl2:MessageIn Id="_5-oAGmWNEd6oJedOmyoJMA"/>
                <xpdl2:MessageOut Id="_5-oAG2WNEd6oJedOmyoJMA"/>
              </xpdl2:TaskUser>
            </xpdl2:Task>
          </xpdl2:Implementation>
          <xpdl2:Performers>
        ...
        <xpdl2:Activity Id="_5-oAHGWNEd6oJedOmyoJMA" Name="start" xpdExt:DisplayName="start" xpdExt:Visibility="Public">
          <xpdl2:Implementation>
            <xpdl2:Task>
              <xpdl2:TaskService xpdExt:ImplementationType="Orchestrator" Implementation="Other">
                <xpdl2:MessageIn Id="_5-oAHWWNEd6oJedOmyoJMA"/>
                <xpdl2:MessageOut Id="_5-oAHmWNEd6oJedOmyoJMA"/>
                <orchestrator:Orchestrator>
                  <orchestrator:OrchestratorMessageInformation orchestrator:MessageType="Start Plan"/>
                  <orchestrator:StartPlanMessageInformation orchestrator:GraftStepName="_5-oAH2WNEd6oJedOmyoJMA" orchestrator:ExecutionPlanIdOverrideField="_5-xxC2WNEd6oJedOmyoJMA" orchestrator:OrchestratorStepName="_5-oAFWWNEd6oJedOmyoJMA">
                    <orchestrator:OrderPlanType/>
                  </orchestrator:StartPlanMessageInformation>
                </orchestrator:Orchestrator>
              </xpdl2:TaskService>
            </xpdl2:Task>
          </xpdl2:Implementation>
        ...
        <xpdl2:Activity Id="_5-oAH2WNEd6oJedOmyoJMA" Name="graf" FinishMode="Automatic" StartMode="Automatic" xpdExt:Visibility="Private" xpdExt:DisplayName="graf">
          ...
          <iProcessExt:TaskProperties NoDeleteOnWithdraw="false" IgnoreCaseSuspend="false">
            <iProcessExt:Prediction UseDeadlineForDuration="false" DontIncludeAsFutureWorkItem="false"/>
            <iProcessExt:DynamicSubProcessTask IsGraftStep="true" HaltOnBadSubProcess="false" HaltOnBadIOTemplate="false" HaltOnBadIOTemplateVersion="false"/>
          </iProcessExt:TaskProperties>
        </xpdl2:Activity>
    ...
    <xpdl2:WorkflowProcess Id="_FzLEwGWREd6PYY5FBn3-0A" iProcessExt:NextParamSequenceNum="3" xpdExt:DisplayName="IPCPC" Name="IPCPC">
      <xpdl2:ProcessHeader>
        <xpdl2:Description></xpdl2:Description>
      </xpdl2:ProcessHeader>
      <xpdl2:DataFields>
      ...
      <xpdl2:Activities>
        ...
        <xpdl2:Activity Id="_FzLExmWREd6PYY5FBn3-0A" Name="StartTask" xpdExt:DisplayName="Start Task" xpdExt:Visibility="Public">
          <xpdl2:Implementation>
            <xpdl2:Task>
              <xpdl2:TaskService xpdExt:ImplementationType="Orchestrator" Implementation="Other">
                <xpdl2:MessageIn Id="_KIL9MGWREd6PYY5FBn3-0A"/>
                <xpdl2:MessageOut Id="_KIL9MWWREd6PYY5FBn3-0A"/>
                <orchestrator:Orchestrator>
                  <orchestrator:OrchestratorMessageInformation/>
                </orchestrator:Orchestrator>
              </xpdl2:TaskService>
            </xpdl2:Task>
          </xpdl2:Implementation>
        ...
        <xpdl2:Activity Id="_FzLEyWWREd6PYY5FBn3-0A" Name="Cancel" xpdExt:Visibility="Private" xpdExt:DisplayName="Cancel">
          <xpdl2:Implementation>
            <xpdl2:Task>
              <xpdl2:TaskReceive xpdExt:ImplementationType="Unspecified" Implementation="Unspecified">
                <xpdl2:Message Id="_FzLEymWREd6PYY5FBn3-0A"/>
              </xpdl2:TaskReceive>
            </xpdl2:Task>
          </xpdl2:Implementation>
          <xpdl2:NodeGraphicsInfos>
        ...
        <xpdl2:Activity Id="_FzLE0GWREd6PYY5FBn3-0A" Name="TaskComplete" xpdExt:Visibility="Public" xpdExt:DisplayName="Task Complete">
          <xpdl2:Implementation>
            <xpdl2:Task>
              <xpdl2:TaskService xpdExt:ImplementationType="Orchestrator" Implementation="Other">
                <xpdl2:MessageIn Id="_FzLE0WWREd6PYY5FBn3-0A"/>
                <xpdl2:MessageOut Id="_FzLE0mWREd6PYY5FBn3-0A"/>
                <orchestrator:Orchestrator>
                  <orchestrator:OrchestratorMessageInformation orchestrator:MessageType="Task Complete"/>
                </orchestrator:Orchestrator>
              </xpdl2:TaskService>
            </xpdl2:Task>
          </xpdl2:Implementation>
        ...
        <xpdl2:Activity Id="_MXYYoGWREd6PYY5FBn3-0A" Name="OrderStep" xpdExt:Visibility="Private" xpdExt:DisplayName="Order Step">
          <xpdl2:Implementation>
            <xpdl2:Task>
              <xpdl2:TaskService xpdExt:ImplementationType="Order" Implementation="Other">
                <xpdl2:MessageIn Id="_NnjAAGWREd6PYY5FBn3-0A"/>
                <xpdl2:MessageOut Id="_NnjAAWWREd6PYY5FBn3-0A"/>
                <order:Order>
                  <order:OrderIdentification order:OrderPrimaryKeyField="_FzLE3WWREd6PYY5FBn3-0A" order:OrderAmendmentIndexField="_FzLE3GWREd6PYY5FBn3-0A"/>
        ...
        <xpdl2:Activity Id="_qF86UGWREd6PYY5FBn3-0A" Name="StartEvent" xpdExt:DisplayName="Start Event" xpdExt:Implements="_pBjeEGWREd6PYY5FBn3-0A" xpdExt:Visibility="Public">
          <xpdl2:Event>
            <xpdl2:StartEvent Trigger="None"/>
          </xpdl2:Event>
          <xpdl2:NodeGraphicsInfos>
  ...
  <xpdExt:ProcessInterfaces>
    <xpdExt:ProcessInterface Id="_5-oAAmWNEd6oJedOmyoJMA" xpdExt:DisplayName="graft-Interface" iProcessExt:NextParamSequenceNum="2" Name="graftInterface">
      <xpdl2:FormalParameters>
        <xpdl2:FormalParameter Id="_5-oAA2WNEd6oJedOmyoJMA" Name="Plan" IsArray="false" Mode="INOUT" Required="false" xpdExt:DisplayName="Plan" iProcessExt:SequenceNum="1">
          <xpdl2:DataType>
            <xpdl2:BasicType Type="STRING">
              <xpdl2:Length>50</xpdl2:Length>
            </xpdl2:BasicType>
    ...
    <xpdExt:ProcessInterface Id="_nvmG8GWREd6PYY5FBn3-0A" xpdExt:DisplayName="ipcpc-Interface" iProcessExt:NextParamSequenceNum="2" Name="ipcpcInterface">
      <xpdl2:FormalParameters>
        <xpdl2:FormalParameter Id="_za4pYGWREd6PYY5FBn3-0A" Name="parameter" Mode="INOUT" Required="true" xpdExt:DisplayName="parameter" iProcessExt:SequenceNum="1">
          <xpdl2:DataType>
            <xpdl2:BasicType Type="STRING">
              <xpdl2:Length>50</xpdl2:Length>
            </xpdl2:BasicType>
